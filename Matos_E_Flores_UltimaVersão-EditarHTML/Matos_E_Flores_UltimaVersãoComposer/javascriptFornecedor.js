   ...
   $("body").on("click", ".edit-item", function () {
    ...
    $(".crud-submit-edit").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: form_action,
            data: { idfornecedor: idfornecedor, fornecedor: fornecedor, telefone: telefone, email_fornecedor: email_fornecedor, cnpj_fornecedor: cnpj_fornecedor, rua_fornecedor: rua_fornecedor, numero_fornecedor: numero_fornecedor, complemento_fornecedor: complemento_fornecedor, bairro_fornecedor: bairro_fornecedor, cidade_fornecedor: cidade_fornecedor, estado_fornecedor: estado_fornecedor,cep_fornecedor: cep_fornecedor}
        }).done(function (data){;
            getPageData();
