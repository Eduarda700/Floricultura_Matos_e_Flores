...
<head>
    ...
    <style>
        ...
        .page-title-box {font-family: 'Italiana'; background-color: #d3bdf0; padding: 15px; border-radius: 10px; margin-bottom: 20px; text-align: center; }
        .page-title-box h2 { color: #3c1361;; margin: 0; }
        .navbar .navbar-text { color: #3c1361 !important; float: right; margin-top: 40px; }
        .btn-success, .btn-primary { background-color: #d3bdf0; border-color: #7a29a4;color: #3c1361; }
        .btn-success:hover, .btn-primary:hover { background-color: #d3bdf0; color: #3c1361;}
        .modal-header { background-color: #d3bdf0; color: #3c1361; }
        .table-bordered > thead > tr { background-color: #d3bdf0; color: #3c1361; }
        .btn-danger {background-color: #3c1361; color: #d3bdf0;
        border-color: #3c1361;}
        .btn-danger:hover {background-color: #3c1361;color: #d3bdf0; opacity: 0.9;}
