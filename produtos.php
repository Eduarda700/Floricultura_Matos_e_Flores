...
$res = mysqli_query($conn, "SELECT * FROM produto ORDER BY nome_produto ASC LIMIT $offset, $itens_por_pagina");
  ...
  <?php
   ...
   <div class="product-card">
        ...
        <div class="product-info">
          ...
          <button class="product-button1" data-id="<?= $p['idproduto'] ?>">Ver Detalhes</button>
...
<script>
$(document).on('click', '.product-button1', function(e) {
  e.preventDefault();

  const id = $(this).data('id');
  console.log("Produto clicado, ID:", id);
  ...
  $.get('detalhes_produto.php', { id: id }, function(data) {
...
$(document).on('click', '.modal-close, #produtoModal', function(e) {
